      ...
      <div className="relative">
        <div className="md:grid md:grid-cols-2 flex flex-col-reverse ">
          ...
          <div className="mx-0 pt-10 md:pb-0 pb-10 md:mx-auto md:px-4 px-6 bg-white bg-opacity-75">
            <div className="">
              <h2 className="font-bold text-3xl text-darkText md:text-left  text-center ">
                Sign Up
              </h2>
              <button
              ...
              <form onSubmit={signupEmail}>
                <div className="mt-11">
                  ...
                  <input
                    ...
                    value={email}
                    className="rounded-lg border-2 w-full border-borderLight border-opacity-80 py-4 px-4 mt-2 mb-2"
                    type="text"
                    name=""
                    id=""
                ...
                <div>
                  <div className="font-medium text-lg text-darkText flex justify-between items-center mt-3">
                  ...
                  <input
                    ...
                    id=""
                  />
                  <span className="font-medium text-xs text-grayText">
                ...
                <div className="w-full flex items-center">
                  <div className=" rounded-lg ">
                    <input
                      ...
                      checked={privacy}
                      className=" rounded-lg  w-full  font-normal text-grayText"
                      type="checkbox"
                      id="privacy"
                      name="privacy"
                    />
                  </div>
                  <label htmlFor="privacy" className="pl-2 text-lg font-normal text-grayText">
                ...
                <div className="w-full mt-2 flex items-center">
                  ...
                  <label htmlFor="subscribe" className="pl-2 text-lg font-normal text-grayText">
                ...
                <div className="mt-11">
                  ...
                  <h4 className="font-medium text-base text-grayText">
