            ...
            <div className="container mx-auto lg:p-16 p-10">
                <div className=" lg:flex md:flex grid justify-between grid-cols-2 gap-5 lg:mx-14 md:mx-14 mx-0">
                    ...
                    <div className="text-white">
                        ...
                        <h5 className="pb-8">477 Chestnut Drive<br/>
                        ,New York, NY 10023</h5>
                        </div>
                    </div>
                </div>
                <div className="flex justify-center mt-6 mb-10">
                    <div className="grid grid-cols-4 gap-3 text-2xl">
                    <div className="w-10 h-10 rounded-lg bg-white flex justify-center pt-2"><TiSocialFacebook/></div>
                    <div className="w-10 h-10 rounded-lg bg-white flex justify-center pt-2"><SlSocialInstagram/></div>
                ...
                <div className="text-white text-lg font-bold text-center pt-8 lg:mx-14 md:mx-14 mx-0"><h4>Copyright © 2024 Shoply. All rights reserved.</h4></div>
            </div>
            </div>
        </Fragment>
    )
