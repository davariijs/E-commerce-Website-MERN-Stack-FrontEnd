...
export default function CheckOut() {
  ...
  const [editingAddress] = useState(null);
  ...
  const handleDeleteCart = async (cartId: string | null, uid: string | null) => {
    try {
      ...
      const result = await authenticatedFetch(
        `${process.env.REACT_APP_URL_API}/api/cart/${cartId}`,
        {
          method: 'DELETE',
          headers: {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        notifyError('An unexpected error occurred during checkout');
      }
    }
  };
  ...
  return (
    <Fragment>
      <div className="container mx-auto w-full h-full accountPage">
        <div className="pb-12 pt-3 flex lg:text-lg">
          <Link
            to="/"
            onClick={e => {
              e.preventDefault();
          ...
          <Link to="/account" className="pl-3 pr-3 text-grayText font-normal ">
            My Account
          </Link>
          <img src={leftArrowIcon} width="5px" height="10.14px" alt="arrow" />
        ...
        <div className="text-darkText flex md:text-2xl text-lg font-bold ">
          <div className="title-part "></div>
          <h3 className="pl-3 pt-1">Check Out</h3>
        </div>
        ...
        <div className="flex md:flex-row flex-col-reverse">
          <div className="pb-8 lg:pt-0 pt-4 lg:w-3/4 w-full md:mr-10">
            ...
            <form onSubmit={handleSubmit}>
              <div className="pt-6 pb-6 border-b-2 border-secondary">
                <h3 className="text-darkText md:text-xl text-base font-bold pb-3">
                  Shipping Method
                </h3>
                <div className="rounded-xl bg-secondary py-9 px-7 mt-7 ">
                  <div className="w-full pb-6 border-b-2 border-borderGrey">
                    <h4 className="font-bold md:text-lg text-base text-darkText">
                      Arrives by {nextFiveDays[5]}
                    </h4>
                  </div>
                  ...
                  <div className="w-full mt-6">
                    ...
                    <h5 className="text-grayText font-light md:text-base text-sm pt-2">
                ...
                <div className="rounded-xl bg-secondary py-9 px-7 mt-7 ">
                  <div className="w-full  pb-6 border-b-2 border-borderGrey">
                    <div className="flex ">
                      <div className=" rounded-lg ">
                        <input
                          ...
                          className=" rounded-lg  w-4 h-4 md:mt-3 mt-1 font-normal text-grayText"
                          type="radio"
                          id="creditCard"
                          name="creditCard"
                      ...
                      <div>
                        <label
                          ...
                          className="pl-4 md:-mt-4  font-bold md:text-lg text-base text-darkText"
                        >
                          Credit Card
                        </label>
                        <p className="text-darkText font-medium text-sm pl-4">
                    ...
                    <div className="grid md:grid-cols-6 grid-cols-4 gap-3 mt-6 ml-8">
                      <div className="bg-white rounded-md py-3 px-2 flex justify-center items-center">
                        <img src={googlePay} className="" alt="" />
                      </div>
                      <div className="bg-white rounded-md py-3 px-2 flex justify-center items-center">
                        <img src={visa} alt="" />
                      </div>
                      ...
                      <div className="grid md:grid-cols-2 grid-cols-1 md:gap-8 gap-4 mt-6 ml-8">
                        <div className="w-full">
                          <div className="bg-secondary rounded-lg mt-2 border-2 border-grayText">
                            <input
                              ...
                              value={cardNumber}
                              className="bg-secondary text-xs rounded-lg  w-full font-normal text-grayText py-4 px-5"
                              type="text"
                              id="cardNumber"
                              name="cardNumber"
                        ...
                        <div className="w-full">
                          <div className="bg-secondary rounded-lg mt-2 border-2 border-grayText flex justify-between">
                            ...
                            />
                            <button className="flex justify-center items-center text-grayText">
                              <IoMdEye className="mr-4" />
                              <IoMdEyeOff className="mr-4" />
                            </button>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="w-full mt-6 flex pb-6 border-b-2 border-borderGrey">
                    ...
                    <div>
                      <label
                        htmlFor="billingAddress"
                        className="pl-4 md:-mt-1  font-bold md:text-lg text-base text-darkText"
                      >
                        Cash on delivery
                      </label>
                      <p className="text-darkText font-medium text-sm pl-4">
                  ...
                  <div className="w-full mt-6 flex">
                    <div className=" rounded-lg ">
                      <input
                        ...
                        className=" rounded-lg  w-4 h-4 md:mt-0 mt-1 font-normal text-grayText"
                        type="radio"
                        id="paypal"
                        name="paypal"
                        placeholder="Delivery Instruction"
          ...
          <div className="pb-8 py-6 px-6 lg:w-1/4 w-full h-fit border-2 rounded-lg border-secondary md:my-0 my-6">
            <h3 className="font-bold md:text-2xl text-base pb-3 border-b-2 border-borderGrey">
              Order Summary
            </h3>
            ...
            {items.map((item: TCartItem) => (
              <div
                key={item._id}
                className="flex justify-between items-center font-bold text-sm  py-5 border-b-2 border-borderGrey"
              >
                <div className="flex">
                  <img
                    className="rounded-md w-16 h-16 md:mr-4 mr-3"
                    src={item.image}
                    alt={item.title}
                  />
                  <div className="text-darkText ">
                    <h4 className="">
                      {item.title}
                      <span className="text-grayText font-light"> x {item.quantity}</span>
                    </h4>
                    <h4 className="mt-2">
                      Color : <span className="text-grayText font-light">{item.color}</span>
                    </h4>
                  </div>
                </div>
            ...
            <div className="py-4 border-b-2 border-borderGrey text-darkText font-bold md:text-lg text-sm">
              <div className="flex justify-between">
                <h4 className="">
                  Subtotal{' '}
                  <span className="text-grayText font-light">( {totalQuantity} items )</span>
                </h4>
