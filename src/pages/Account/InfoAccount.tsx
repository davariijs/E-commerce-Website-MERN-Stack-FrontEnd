              ...
              <div className="pb-4 w-full">
                <form onSubmit={handleFormSubmission}>
                  ...
                  <div className="w-full mt-8">
                    ...
                    <div className="bg-secondary rounded-lg mt-2">
                      <textarea
                        ...
                        value={instruction}
                        className="bg-secondary text-xs rounded-lg  w-full font-normal text-grayText pt-4 h-36 px-5"
                        id="delivery"
                        name="delivery"
                  ...
                  <div className="w-full mt-8 flex">
                    ...
                    <label htmlFor="shipping" className="pl-2 text-sm font-normal text-darkText">
                  ...
                  <div className="w-full mt-2 flex">
                    ...
                    <label htmlFor="billing" className="pl-2 text-sm font-normal text-darkText">
                      Set as default billing address
                    </label>
                  </div>

                  <div className="md:flex grid grid-cols-2 md:gap-6 gap-4 mt-9 md:font-bold md:text-xl">
                    <button className="rounded-lg  text-white md:w-32 w-full h-12 bg-primary">
                      Save
                    </button>
                    <button
                      onClick={() => {
                        onSave(defaultPayload);
                      }}
                      className="rounded-lg text-grayText  md:w-32 w-full h-12 bg-secondary"
                    >
                      Cancel
                    </button>
                  </div>
