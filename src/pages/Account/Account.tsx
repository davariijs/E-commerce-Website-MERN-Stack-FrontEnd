        ...
        {uid ? (
          <div className="lg:flex pb-8 ">
            ...
            <div className="pb-8 lg:pt-0 pt-8 lg:w-3/4 w-full">
              <h3 className="text-darkText flex lg:text-2xl text-md font-bold md:pb-14 pb-3">
                {path}
              </h3>
              <Outlet />
            </div>
          ...
          <div className="flex flex-col justify-center items-center text-center p-20">
            <h2 className="text-darkText font-bold md:text-3xl text-lg ">
              User doesn&apos;t exist!!!
            </h2>
            <Link
              to="/sign-up"
              className="bg-primary rounded-lg text-white px-5 py-4 text-center items-center w-full mb-2 mt-10"
            >
              Sign Up
            </Link>
