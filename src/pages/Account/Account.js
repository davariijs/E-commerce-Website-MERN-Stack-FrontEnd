    ...
    return(
        <Fragment>
            ...
            <div className="lg:flex pb-8 ">
                <div className="pr-14 lg:w-1/4 w-full">
                ...
                <div className="pb-8 lg:pt-0 pt-8 lg:w-3/4 w-full">
                    ...
                    <h3 className='text-darkText flex lg:text-2xl text-lg font-bold pb-3'>My Info</h3>
                    <h4 className='text-darkText flex lg:text-xl text-lg font-bold pb-8'>Contact Details</h4>

                    <div className="pb-4 border-b-2 border-borderGreyLight w-full">
                        <h4 className="text-lg font-semibold text-grayText">Your Name</h4>
                        <div className="flex justify-between">
                            <h5 className="text-lg font-semibold text-darkText">Jhanvi Shah</h5>
                            <button className="text-lg font-semibold text-darkText">Change</button>
                        </div>
                    </div>

                    <div className="py-4 border-b-2 border-borderGreyLight w-full">
                        <h4 className="text-lg font-semibold text-grayText">Email Address</h4>
                        <div className="flex justify-between">
                            <h5 className="text-lg font-semibold text-darkText">Jhanvi@gmail.com</h5>
                            <button className="text-lg font-semibold text-darkText">Change</button>
                        </div>
                    </div>

                    <div className="py-4 border-b-2 border-borderGreyLight w-full">
                        <h4 className="text-lg font-semibold text-grayText">Phone Number</h4>
                        <div className="flex justify-between">
                            <h5 className="text-lg font-semibold text-darkText">8980252445</h5>
                            <button className="text-lg font-semibold text-darkText">Change</button>
                        </div>
                    </div>

                    <div className="py-4 border-b-2 border-borderGreyLight w-full">
                        <h4 className="text-lg font-semibold text-grayText">Password</h4>
                        <div className="flex justify-between">
                            <h5 className="text-lg font-semibold text-darkText">.....</h5>
                            <button className="text-lg font-semibold text-darkText">Change</button>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <h4 className='text-darkText flex lg:text-xl text-lg font-bold '>Address</h4>
                        <button className="text-lg font-semibold text-darkText">Add New</button>
                        </div>

                        <div className=" grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <div className="rounded-xl p-5 bg-secondary">
                                <h3 className="text-xl font-semibold text-darkText pb-4">Jhanvi shah</h3>
                                ...
                                <div className="flex pb-4">
                                    <div className="mr-3 rounded-lg py-2 px-5 border-2 border-grayText text-base font-normal text-grayText">Home</div>
                                    <div className="mr-3 rounded-lg py-2 px-5 border-2 border-grayText text-base font-normal text-grayText">Default billing address</div>
                                </div>
