        ...
        <div className="lg:flex md:flex">
          <div className="w-full h-full  relative m-auto">
            ...
            <div className="fashionPartText ">
              <h2 className="font-extrabold lg:text-4xl md:text-3x1 text-lg text-white">
                WE MADE YOUR EVERYDAY FASHION BETTER!
              </h2>
              <p className="font-light lg:text-xl md:text-lg text-xs lg:pt-7 md:pt-3 md:pb-5 pt-1 pb-3 lg:pb-14 text-white">
                In our journey to improve everyday fashion, euphoria presents EVERYDAY wear range -
                Comfortable & Affordable fashion 24/7
              </p>
              <Link
                to=""
                className="text-darkText font-semibold lg:text-lg text-sm lg:px-9 md:px-5 px-1 py-1 md:py-2 lg:py-3 text-nowrap bg-white text-center lg:rounded-lg rounded-md"
              >
                Shop Now
              </Link>
            </div>
