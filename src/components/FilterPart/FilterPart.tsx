    ...
    <Fragment>
      <div className="border-2 border-t-0 border-opacity-35 border-borderGrey h-fit lg:w-1/4 w-full">
        ...
        <div className="text-grayText font-semibold text-base lg:grid-rows-6 grid-rows-1 lg:p-8 p-5 grid lg:grid-cols-1 sm:grid-cols-6 grid-cols-3 lg:gap-5  gap-4 text-center lg:text-left">
          ...
          <Link to={secondPath} className="flex justify-between lg:w-full w-fit hover:text-primary">
            {secondItem}
            <GoChevronRight className="lg:block hidden w-5 h-6 hover:text-primary" />
          </Link>
          <Link to={thirdPath} className="flex justify-between lg:w-full w-fit hover:text-primary">
            {thirdItem}
            <GoChevronRight className="lg:block hidden w-5 h-6 hover:text-primary" />
          </Link>
          <Link to={fourthPath} className="flex justify-between lg:w-full w-fit hover:text-primary">
            {fourthItem}
            <GoChevronRight className="lg:block hidden w-5 h-6 hover:text-primary" />
          </Link>
          <Link to={fifthPath} className="flex justify-between lg:w-full w-fit hover:text-primary">
            {fifthItem}
            <GoChevronRight className="lg:block hidden w-5 h-6 hover:text-primary" />
          </Link>
          <Link to={sixthPath} className="flex justify-between lg:w-full w-fit hover:text-primary">
            {sixthItem}
            <GoChevronRight className="lg:block hidden w-5 h-6 hover:text-primary" />
          </Link>
        </div>
