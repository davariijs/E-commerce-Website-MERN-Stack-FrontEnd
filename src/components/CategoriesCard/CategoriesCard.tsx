...
export default function CategoriesCard({
  ...
  return (
    <Fragment>
      <div className="categoriesCardSection" data-aos="fade-up">
        <div className="relative categoriesCardImgPart">
          ...
          {categoriesFashionCard ? (
            ...
            <div
              onClick={onClick}
              className="cardSvgLike absolute bg-white w-8 h-8 flex justify-center lg:top-6 lg:right-7 top-2 right-2 z-10 cursor-pointer"
        ...
        <div className="pt-4">
          <div className="flex justify-between">
            <div className="">
              <h3 className="font-bold lg:text-lg md:text-lg text-sm text-textCategory">
                {textCategoriesCard}
              </h3>
              {categoriesFashionCard ? (
                <h5 className="pt-1 font-normal lg:text-sm md:text-sm text-xs  text-textThinGray">
                  Explore Now!
                </h5>
              ) : (
                <h5 className="pt-1 font-normal lg:text-sm md:text-sm text-xs  text-textThinGray">
            ...
            <div>
              {categoriesFashionCard ? (
                <div className="text-darkText mt-5">
                  <GoArrowRight />
                </div>
              ) : (
                <div className="text-darkText bg-secondary lg:px-4 lg:py-2 md:px-4 md:py-2 px-2 py-1 font-bold text-sm rounded-lg mt-4">
                  ${price}
                </div>
              )}
            </div>
