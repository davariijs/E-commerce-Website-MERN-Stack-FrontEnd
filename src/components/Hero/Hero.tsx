          ...
          <div className="CarouselFirst">
            ...
            <div className="legend absolute">
              <div>
                ...
                <h1 className="lg:text-7xl md:text-lg text-base font-extrabold">
                  Summer Value Pack
                </h1>
                <h4 className="lg:text-3xl md:text-base text-sm">cool / colorful / comfy</h4>
                <Link to="/women">
                  <button className="lg:text-3xl md:text-base text-sm text-darkText font-semibold bg-white rounded-lg lg:py-4  lg:px-16 py-2 px-8">
                    Shop Now
                  </button>
                </Link>
              </div>
